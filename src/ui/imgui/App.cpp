...
void App::renderDockspace()
{
    ...
    if (firstRun)
    {
        ...
        // Create layout: Browser | Main | Inspector
        ImGuiID dockLeft, dockMain, dockRight, dockBottom;
        
        ImGui::DockBuilderSplitNode(dockspaceId, ImGuiDir_Left, 0.2f, &dockLeft, &dockMain);
